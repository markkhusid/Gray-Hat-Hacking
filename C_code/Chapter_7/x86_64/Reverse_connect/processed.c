# 1 "reverse_connect.c"
# 1 "/home/mark/Engineering/Programming/GITHUB/Gray_Hat_Hacking/C_code/Chapter_7/x86_64/Reverse_connect//"
# 1 "<built-in>"
#define __STDC__ 1
...
int main()
{
    ...
    serv_addr.sin_addr.s_addr = 0x650A0A0A;
